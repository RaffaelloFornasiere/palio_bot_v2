...
class Container:
    ...
    def __init__(
        self,
        config: Config = None,
        llm_provider: Literal["openrouter", "llamacpp", "ollama"] = None,
        ...
        Args:
            ...
            ollama_model: Model name for Ollama (defaults to config.ollama_model)
        """
        if config is None:
            config = Config()
    ...
    def file_manager(self) -> FileManager:
        ...
        if self._file_manager is None:
            self._file_manager = FileManager(self.file_registry())
